                ...
                <div class="content-wrapper">
                    <div class="content">
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-md-12"><a href="{{route('product.create')}}" class="btn btn-success m-4 float-left">Thêm</a></div>
                          <div class="col-md-12">
                            <table class="table">
                              <thead>
                                <tr>
                        ...
                        <div class="rol">
                          <div class="col-sm-3"> {{ $products->onEachSide(5)->links('pagination::bootstrap-4') }} {{--hien thi phan con lai cua trang (phan lai trang)--}}</div>
